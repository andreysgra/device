# Проект «Девайс» от [HTML Academy](https://htmlacademy.ru/)

[![Build status][travis-image]][travis-url] [![Dependency status][dependency-image]][dependency-url]

Вёрстка: [Андрей Грачев](https://github.com/andreysgra/)

[Демо проекта](https://andreysgra.github.io/device/)
...
[travis-image]: https://travis-ci.org/andreysgra/device.svg?branch=master
[travis-url]: https://travis-ci.org/andreysgra/device
[dependency-image]: https://david-dm.org/andreysgra/device/dev-status.svg?style=flat-square
[dependency-url]: https://david-dm.org/andreysgra/device?type=dev
